...
class DinnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dinner" do
    assert_difference('Dinner.count') do
      post dinners_url, params: { dinner: { recipe: @dinner.recipe, start_time: @dinner.start_time } }
    end
  ...
  test "should update dinner" do
    patch dinner_url(@dinner), params: { dinner: { recipe: @dinner.recipe, start_time: @dinner.start_time } }
